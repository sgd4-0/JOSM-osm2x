...
int main(int argc, char *argv[]) {
    /*
        1. Nutzen der API zum Download von Daten -> sp�ter
        2. prefilter mit C++ -> sp�ter
        3. JOSM starten -> Daten augmentieren -> Datei speichern -> sp�ter
    ...
    */
    ...
    // Einbinden von ben�tigten Variablen
