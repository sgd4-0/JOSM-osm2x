...
public class Osm2XMesher {
	...
	private LatLon calculateNode(LatLon origin, Entry<Double, Way> way1, Entry<Double, Way> way2) {
		...
		//System.out.print("Alpha: " + ang_diff);
		...
		//System.out.printf("xy = (%.4f, %.4f), ", x, y);
		...
		//System.out.printf("lat/lon: %.7f, %.7f - ", y,x);
	...
	private double parseDouble(String s) {
		...
		try {
			...
			//System.out.println("Try to match " + s);
			if (matcher.find()) {
				try {
					String str = matcher.group();
					//System.out.println("Found match " + str);
					d = Double.valueOf(str);
					//System.out.println("Double creation was successful: " + d);
